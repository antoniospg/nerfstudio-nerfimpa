...
@dataclass
class CustomVanillaModelConfig(ModelConfig):
    """Vanilla Model Config"""

    _target: Type = field(default_factory=lambda: CustomVanillaModel)
...
class CustomVanillaModel(Model):
    """Vanilla NeRF model
    ...
    config:CustomVanillaModelConfig
    ...
    def populate_modules(self):
        ...
        self.field_coarse = CustomVanillaField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )

        self.field_fine = CustomVanillaField(
            position_encoding=position_encoding,
            direction_encoding=direction_encoding,
        )
